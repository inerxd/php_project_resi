...
<script src="https://kit.fontawesome.com/dc7acab7cc.js" crossorigin="anonymous"></script>
 <link rel="stylesheet" href="{{asset('proyecto/contenido/css/estilos.css') }}"  />
    ...
    <img src="{{ asset('images/itvh.png') }}" alt="" style="width:80px;">
                 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                      ...
                      @if (Route::has('login'))
                      @auth
                      <a href="home" class="text-sm text-gray-700 underline">pagina</a>
                      @else
                        <a class="nav-item nav-link active" href="#"><i class="fas fa-home"><br>Inicio  </i></a>

                        <a class="nav-item nav-link" href="{{ route('login') }}"><i class="fas fa-poll-h"></i><br>Iniciar sesion 
                        </a>
                        @if (Route::has('register'))
                        <a class="nav-item nav-link" href="{{ route('register') }}"><i class="fas fa-address-card"><br>Registrarse</i> </a>
                        @endif
                    @endauth
                      </div>
                      @endif
...
<!-- Textos -->
  <div class="col-12 text-center py-4">
    <h2 class="text-warning text-uppercase h6">Tu puedes</h2>
     <h3 class="text-capitalize">No de rindas tan facilmente </h3>
       </div>
 </div>
<!-- Cartas -->
<!-- Cartas 1 -->
 <div class="wrap">
   <div class="tarjeta-wrap">
     <div class="tarjeta">
       ...
       <div class="atras"> <p class="h2"> Bievendio , te estabamos esperando
       </p> </div>
    </div>
      </div>
        <!-- Cartas 2 -->
...
<div class="tarjeta-wrap">
     <div class="tarjeta">
       ...
       <div class="atras"> <p class="h2"> De podemos ayudar ,si lo deseas
       </p> </div>
    </div>
      </div>
<!-- Cartas 3 -->
     ...
     <div class="tarjeta">
       ...
       <div class="atras"> <p class="h2"> pero tienes que ser honesto al contestar las encuestas
       </p> </div>
    </div>
      </div>
